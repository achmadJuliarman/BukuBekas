...
<div class="card d-flex flex-row flex-wrap justify-content-center" style="margin-bottom: 100px; width: 60vw;" >
		...
		style="width: 15vw; margin-left: 1vw;">
			...
			data-idB="<?= $b['id_buku']; ?>" data-idU="<?= $b['id_user']; ?>" 
			data-judul="<?= $b['judul']; ?>" data-harga="<?= $b['harga']; ?>" 
			data-no="<?= $b['no_telp']; ?>" data-deskripsi="<?= $b['deskripsi']; ?>"
			data-cover="<?= $b['cover']; ?>">
				Lihat Detail.. 
  ...
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-footer">
	    ...
	    <button class="btn btn-outline-primary" id="favorite" style="<?php if (!isset($_SESSION['login']) ) {echo "display: none;";} ?>">
			<a href="" style="text-decoration: none; text-shadow: 1px 1px 1px 1px;" target="blank">Tambah Ke Favorite</a>
	    </button>
      </div>
    </div>
  </div>
